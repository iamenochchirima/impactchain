...
import {
  InclusionPoliciesData as InclusionPoliciesDataType,
  Testimonials,
...
const InclusionPoliciesData = ({ setManualData, setUploadManually }) => {
  ...
  const handleSubmit = async () => {
    ...
    if (programs.length === 0) {
      toast.error(
        "Please add at least one inclusion policies program you did",
        {
          position: "top-center",
          autoClose: 5000,
          hideProgressBar: false,
  ...
  return (
    <div>
      <div className="">
        <h3 className={styles.title}>Inclusion Policies</h3>
        ...
        <div className={styles.munualDataForm}>
          ...
          <div className={styles.inputDiv}>
            <label htmlFor={styles.inputLabel}>
              What is the name of the Inclusion Policies program?
            </label>
            <input
          ...
          <div className={styles.inputDiv}>
            <label htmlFor={styles.inputLabel}>
              What type of policy is implemented?
            </label>
            <select
            ...
            >
              <option value="">
                Select the type of inclusion policy implemented from the
                dropdown.
              </option>
