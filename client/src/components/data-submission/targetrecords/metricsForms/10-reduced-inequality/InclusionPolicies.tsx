...
import {InclusionPoliciesData as InclusionPoliciesDataType } from "../../../../../hooks/declarations/data/data.did";
import { ManualData } from "../../MetricRecords";
import { IoMdAdd } from "react-icons/io";
import Program from "../support/Program";

const InclusionPoliciesData = ({ setManualData, setUploadManually }) => {
  ...
  const [programs, setPrograms] = useState<InclusionPoliciesDataType[]>([]);
  ...
  const handleSubmit = async () => {
    ...
    if (programs.length === 0) {
      toast.error("Please add at least one inclusion policies program you did", {
        position: "top-center",
        autoClose: 5000,
        hideProgressBar: false,
        closeOnClick: true,
    ...
    try {
      ...
      console.log("Error saving inclusion policies program", error);
    }
  };
  ...
  const handleSave = async () => {
    ...
    // const newProgram: InclusionPoliciesDataType = {
    //   programName,
        ...
        <div className={styles.munualDataForm}>
          <div className={styles.formHeader}>
            <h3 className={styles.formTitle}>
              Add a Inclusion Policies Program
            </h3>
          </div>
          <div className={styles.inputDiv}>
            <label htmlFor={styles.inputLabel}>What is the name of the Inclusion Policies program?</label>
            <input
              className={styles.formInput}
              id="programName"
              type="text"
              placeholder="Enter the name of the inclusion policy program."
              value={programName}
          ...
          <div className={styles.inputDiv}>
            <label htmlFor={styles.inputLabel}>What type of policy is implemented?</label>
            <select
              ...
              required
            >
              <option value="">Select the type of inclusion policy implemented from the dropdown.</option>
...
export default InclusionPoliciesData;
