...
import {
  InequalityReductionBeneficiariesData as InequalityReductionBeneficiariesDataType,
  Testimonials,
...
const InequalityReductionBeneficiariesData = ({
  setManualData,
  setUploadManually,
}) => {
  ...
  const [typeOfInequalityAddressed, setTypeOfInequalityAddressed] =
    useState<string>("");
  ...
  const [programs, setPrograms] = useState<
    InequalityReductionBeneficiariesDataType[]
  >([]);
  ...
  const handleSubmit = async () => {
    ...
    if (programs.length === 0) {
      toast.error(
        "Please add at least one inequality reduction beneficiaries program you did",
        {
          position: "top-center",
          autoClose: 5000,
          hideProgressBar: false,
    ...
    try {
      ...
      console.log(
        "Error saving inequality reduction beneficiaries program",
        error
      );
    }
  };
  ...
  return (
    <div>
      <div className="">
        <h3 className={styles.title}>Inequality Reduction Beneficiaries</h3>
        ...
        <div className={styles.munualDataForm}>
          ...
          <div className={styles.inputDiv}>
            <label htmlFor={styles.inputLabel}>
              What is the name of the Inequality Reduction Beneficiary program?
            </label>
            <input
