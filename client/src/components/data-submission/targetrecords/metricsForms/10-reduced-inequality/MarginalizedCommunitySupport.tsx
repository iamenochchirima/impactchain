...
import {
  MarginalizedCommunitySupportData as MarginalizedCommunitySupportDataType,
  Testimonials,
...
const MarginalizedCommunitySupportData = ({
  setManualData,
  setUploadManually,
}) => {
  ...
  const [programs, setPrograms] = useState<
    MarginalizedCommunitySupportDataType[]
  >([]);
  ...
  const handleSubmit = async () => {
    ...
    if (programs.length === 0) {
      toast.error(
        "Please add at least one marginalized community support program you did",
        {
          position: "top-center",
          autoClose: 5000,
          hideProgressBar: false,
  ...
  return (
    <div>
      <div className="">
        <h3 className={styles.title}>Marginalized Community Support</h3>
        ...
        <div className={styles.munualDataForm}>
          ...
          <div className={styles.inputDiv}>
            <label htmlFor={styles.inputLabel}>
              What is the name of the Marginalized Community Support program?
            </label>
            <input
          ...
          <div className={styles.inputDiv}>
            <label htmlFor={styles.inputLabel}>
              What type of community is supported?
            </label>
            <select
            ...
            >
              <option value="">
                Select the type of marginalized community the program supports
                from the dropdown.
              </option>
          ...
          <div className={styles.inputDiv}>
            <label htmlFor={styles.inputLabel}>
              How many beneficiaries are supported by this program?
            </label>
            <input
              className={styles.formInput}
              id="numberOfBeneficiaries"
              type="number"
              placeholder="Enter the total number of beneficiaries supported by this program."
          ...
          <div className={styles.inputDiv}>
            <label htmlFor={styles.inputLabel}>
              How many communities are supported?
            </label>
            <input
              className={styles.formInput}
              id="totalFunding"
