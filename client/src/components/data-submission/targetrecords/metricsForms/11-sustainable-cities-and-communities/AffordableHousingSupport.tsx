...
import {
  AffordableHousingSupportData as AffordableHousingSupportDataType,
  Testimonials,
...
const AffordableHousingSupportData = ({ setManualData, setUploadManually }) => {
  ...
  const [numberOfHousingUnitsSupported, setNumberOfHousingUnitsSupported] =
    useState<string>("");
  ...
  const handleSubmit = async () => {
    ...
    if (programs.length === 0) {
      toast.error(
        "Please add at least one affordable housing support program you did",
        {
          position: "top-center",
          autoClose: 5000,
          hideProgressBar: false,
  ...
  return (
    <div>
      <div className="">
        <h3 className={styles.title}>Affordable Housing Support</h3>
        ...
        <div className={styles.munualDataForm}>
          ...
          <div className={styles.inputDiv}>
            <label htmlFor={styles.inputLabel}>
              What is the name of the Affordable Housing Support program?
            </label>
            <input
          ...
          <div className={styles.inputDiv}>
            <label htmlFor={styles.inputLabel}>
              How many housing units are supported?
            </label>
            <input
              className={styles.formInput}
          ...
          <div className={styles.inputDiv}>
            <label htmlFor={styles.inputLabel}>
              What is the amount funded for the housing units?
            </label>
            <input
              className={styles.formInput}
              id="totalFunding"
