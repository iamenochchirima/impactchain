...
import { UrbanLivingConditionsData as UrbanLivingConditionsDataType } from "../../../../../hooks/declarations/data/data.did";
import { ManualData } from "../../MetricRecords";
import { IoMdAdd } from "react-icons/io";
import Program from "../support/Program";

const UrbanLivingConditionsData = ({ setManualData, setUploadManually }) => {
  ...
  const [numberOfAreasImproved, setNumberOfAreasImproved] = useState<string>("");

  const [programs, setPrograms] = useState<UrbanLivingConditionsDataType[]>([]);
  ...
  const handleSubmit = async () => {
    ...
    if (programs.length === 0) {
      toast.error("Please add at least one urban living conditions program you did", {
        position: "top-center",
        autoClose: 5000,
        hideProgressBar: false,
        closeOnClick: true,
    ...
    try {
      ...
      console.log("Error saving urban living conditions program", error);
    }
  };
        ...
        <div className={styles.munualDataForm}>
          <div className={styles.formHeader}>
            <h3 className={styles.formTitle}>
              Add a Urban living Conditions Program
            </h3>
          </div>
          <div className={styles.inputDiv}>
            <label htmlFor={styles.inputLabel}>What is the name of the Urban living conditions improvement program?</label>
            <input
              className={styles.formInput}
              id="programName"
              type="text"
              placeholder="Enter the name of the urban living conditions improvement initiative."
              value={programName}
          ...
          <div className={styles.inputDiv}>
            ...
            <input
              ...
              id="startDate"
              type="date"
              placeholder="Indicate when these improvements began."
              value={startDate}
              required
          ...
          <div className={styles.inputDiv}>
            ...
            <input
              ...
              id="duration"
              type="text"
              placeholder="Provide the duration that the improvements have been ongoing."
              value={duration}
          ...
          <div className={styles.inputDiv}>
            ...
            <input
              ...
              id="location"
              type="text"
              placeholder="Specify the city and country where the improvements are taking place."
              value={location}
          ...
          <div className={styles.inputDiv}>
            <label htmlFor={styles.inputLabel}>How many areas have been improved?</label>
            <input
              className={styles.formInput}
              id="numberOfAreasImproved"
              type="number"
              placeholder="Enter the number of urban areas that have been improved under this initiative."
              value={numberOfAreasImproved}
              onChange={(e) => setNumberOfAreasImproved(e.target.value)}
              required
            />
          </div>
...
export default UrbanLivingConditionsData;
