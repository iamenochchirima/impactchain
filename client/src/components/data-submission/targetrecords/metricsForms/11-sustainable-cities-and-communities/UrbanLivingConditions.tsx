...
import {
  Testimonials,
  UrbanLivingConditionsData as UrbanLivingConditionsDataType,
...
const UrbanLivingConditionsData = ({ setManualData, setUploadManually }) => {
  ...
  const [numberOfAreasImproved, setNumberOfAreasImproved] =
    useState<string>("");
  ...
  const handleSubmit = async () => {
    ...
    if (programs.length === 0) {
      toast.error(
        "Please add at least one urban living conditions program you did",
        {
          position: "top-center",
          autoClose: 5000,
          hideProgressBar: false,
  ...
  return (
    <div>
      <div className="">
        <h3 className={styles.title}>Urban Living Conditions</h3>
        ...
        <div className={styles.munualDataForm}>
          ...
          <div className={styles.inputDiv}>
            <label htmlFor={styles.inputLabel}>
              What is the name of the Urban living conditions improvement
              program?
            </label>
            <input
          ...
          <div className={styles.inputDiv}>
            <label htmlFor={styles.inputLabel}>
              How many areas have been improved?
            </label>
            <input
              className={styles.formInput}
