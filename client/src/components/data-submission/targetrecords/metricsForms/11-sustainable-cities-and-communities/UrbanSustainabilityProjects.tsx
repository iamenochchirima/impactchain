...
import {
  Testimonials,
  UrbanSustainabilityProjectsData as UrbanSustainabilityProjectsDataType,
...
const UrbanSustainabilityProjectsData = ({
  setManualData,
  setUploadManually,
}) => {
  ...
  const [programs, setPrograms] = useState<
    UrbanSustainabilityProjectsDataType[]
  >([]);
  ...
  const handleSubmit = async () => {
    ...
    if (programs.length === 0) {
      toast.error(
        "Please add at least one urban sustainability program you did",
        {
          position: "top-center",
          autoClose: 5000,
          hideProgressBar: false,
  ...
  return (
    <div>
      <div className="">
        <h3 className={styles.title}>Urban Sustainability Project</h3>
        ...
        <div className={styles.munualDataForm}>
          ...
          <div className={styles.inputDiv}>
            <label htmlFor={styles.inputLabel}>
              What is the name of the Urban Sustainability program?
            </label>
            <input
          ...
          <div className={styles.inputDiv}>
            <label htmlFor={styles.inputLabel}>
              What is the main reason for the project or program?
            </label>
            <select
              className={styles.formSelectInput}
              id="typeOfProject"
            ...
            >
              <option value="">
                Select the main focus of the sustainability project from the
                dropdown.
              </option>
          ...
          <div className={styles.inputDiv}>
            <label htmlFor={styles.inputLabel}>
              How many projects are involved in this initiative?
            </label>
            <input
              className={styles.formInput}
              id="numberOfProjects"
