...
const OrganizationalResourceFootprintReductionData = ({ setManualData, setUploadManually }) => {
  ...
  const [reductionInResourceFootprint, setReductionInResourceFootprint] = useState<string>("");

  const [programs, setPrograms] = useState<OrganizationalResourceFootprintReductionDataType[]>([]);
  ...
  const handleSubmit = async () => {
    ...
    if (programs.length === 0) {
      toast.error("Please add at least one organizational resource footprint reduction program you did", {
        position: "top-center",
        autoClose: 5000,
        hideProgressBar: false,
        closeOnClick: true,
    ...
    try {
      ...
      console.log("Error saving organizational resource footprint reduction program", error);
    }
  };
      ...
      {showForm && (
        <div className={styles.munualDataForm}>
          ...
          <div className={styles.inputDiv}>
            <label htmlFor={styles.inputLabel}>What is the name of the Organizational Resource Footprint Reduction program?</label>
            <input
          ...
          <div className={styles.inputDiv}>
            ...
            <select
              ...
              id="typeOfResources"
              value={typeOfResources}
              onChange={(e) => setTypeOfResources(e.target.value)}
              required
            >
              <option value="">Select the type of resource managed in the reduction efforts from the dropdown.</option>
