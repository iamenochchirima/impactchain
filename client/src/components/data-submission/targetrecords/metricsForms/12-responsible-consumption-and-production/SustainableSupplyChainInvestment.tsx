...
import {
  SustainableSupplyChainInvestmentData as SustainableSupplyChainInvestmentDataType,
  Testimonials,
...
const SustainableSupplyChainInvestmentData = ({
  setManualData,
  setUploadManually,
}) => {
  ...
  const [numberOfSupplyChainImproved, setNumberOfSupplyChainImproved] =
    useState<string>("");
  ...
  const [programs, setPrograms] = useState<
    SustainableSupplyChainInvestmentDataType[]
  >([]);
  ...
  const handleSubmit = async () => {
    ...
    if (programs.length === 0) {
      toast.error(
        "Please add at least one sustainable supply-chain investment program you did",
        {
          position: "top-center",
          autoClose: 5000,
          hideProgressBar: false,
    ...
    try {
      ...
      console.log(
        "Error saving sustainable supply-chain investment program",
        error
      );
    }
  };
  ...
  return (
    <div>
      <div className="">
        <h3 className={styles.title}>Sustainable Supply Chain Investment</h3>
        ...
        <div className={styles.munualDataForm}>
          ...
          <div className={styles.inputDiv}>
            <label htmlFor={styles.inputLabel}>
              What is the name of the Sustainable Supply Chain Investment
              program?
            </label>
            <input
          ...
          <div className={styles.inputDiv}>
            <label htmlFor={styles.inputLabel}>
              What type of investment is used?
            </label>
            <select
            ...
            >
              <option value="">
                Select the type of investment made in the supply chain from the
                dropdown.
              </option>
          ...
          <div className={styles.inputDiv}>
            <label htmlFor={styles.inputLabel}>
              How many supply chains have been improved?
            </label>
            <input
              className={styles.formInput}
          ...
          <div className={styles.inputDiv}>
            <label htmlFor={styles.inputLabel}>
              What is the total amount invested? (In ZAR)
            </label>
            <input
              className={styles.formInput}
              id="amountInvested"
