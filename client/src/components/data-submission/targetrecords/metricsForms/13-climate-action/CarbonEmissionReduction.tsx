...
import {
  CarbonEmissionReductionData as CarbonEmissionReductionDataType,
  Testimonials,
...
const CarbonEmissionReductionData = ({ setManualData, setUploadManually }) => {
  ...
  const [typeOfEmissionReduced, setTypeOfEmissionReduced] =
    useState<string>("");
  ...
  const handleSubmit = async () => {
    ...
    if (programs.length === 0) {
      toast.error(
        "Please add at least one carbon emission reduction program you did",
        {
          position: "top-center",
          autoClose: 5000,
          hideProgressBar: false,
  ...
  const handleSave = async () => {
    ...
    const newProgram: CarbonEmissionReductionDataType = {
      ...
      location,
      typeOfEmissionReduced,
      reductionInEmission: Number(reductionInEmission),
      description,
      objectives,
      notableAchievements,
      challenges,
  ...
  return (
    <div>
      <div className="">
        <h3 className={styles.title}>Carbon Emission Reduction</h3>
        ...
        <div className={styles.munualDataForm}>
          ...
          <div className={styles.inputDiv}>
            <label htmlFor={styles.inputLabel}>
              What is the name of the Carbon Emission Reduction program?
            </label>
            <input
          ...
          <div className={styles.inputDiv}>
            <label htmlFor={styles.inputLabel}>
              What type of emission is reduced?
            </label>
            <select
              className={styles.formSelectInput}
            ...
            >
              <option value="">
                Select the type of emission targeted by the reduction initiative
                from the dropdown.
              </option>
          ...
          <div className={styles.inputDiv}>
            <label htmlFor={styles.inputLabel}>
              What is the amount in emission reduction
            </label>
            <input
              className={styles.formInput}
