...
import {
  ReforestationProjectsData as ReforestationProjectsDataType,
  Testimonials,
...
const ReforestationProjectsData = ({ setManualData, setUploadManually }) => {
  ...
  return (
    <div>
      <div className="">
        <h3 className={styles.title}>Reforestation Program</h3>
      ...
      {showForm && (
        <div className={styles.munualDataForm}>
          <div className={styles.formHeader}>
            <h3 className={styles.formTitle}>Add a Reforestation Program</h3>
          </div>
          <div className={styles.inputDiv}>
            <label htmlFor={styles.inputLabel}>
              What is the name of the Reforestation program?
            </label>
            <input
          ...
          <div className={styles.inputDiv}>
            <label htmlFor={styles.inputLabel}>
              What is the size of the land reforested?
            </label>
            <input
              className={styles.formInput}
