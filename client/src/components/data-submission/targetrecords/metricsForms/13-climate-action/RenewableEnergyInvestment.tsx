...
import {
  RenewableEnergyInvestmentData as RenewableEnergyInvestmentDataType,
  Testimonials,
...
const RenewableEnergyInvestmentData = ({
  setManualData,
  setUploadManually,
}) => {
  ...
  const [typeOfRenewableEnergyInvestment, setTypeOfRenewableEnergyInvestment] =
    useState<string>("");
  ...
  const handleSubmit = async () => {
    ...
    if (programs.length === 0) {
      toast.error(
        "Please add at least one renewable energy investment program you did",
        {
          position: "top-center",
          autoClose: 5000,
          hideProgressBar: false,
  ...
  return (
    <div>
      <div className="">
        <h3 className={styles.title}>Renewable Energy Investment</h3>
        ...
        <div className={styles.munualDataForm}>
          ...
          <div className={styles.inputDiv}>
            <label htmlFor={styles.inputLabel}>
              What is the name of the Renewable Energy Investment program?
            </label>
            <input
          ...
          <div className={styles.inputDiv}>
            <label htmlFor={styles.inputLabel}>
              What type of renewable energy investment is provided?
            </label>
            <select
              ...
              onChange={(e) =>
                setTypeOfRenewableEnergyInvestment(e.target.value)
              }
              required
            >
              <option value="">
                Select the type of renewable energy investment from the
                dropdown.
              </option>
