...
import {
  MarineEcosystemProtectionData as MarineEcosystemProtectionDataType,
  Testimonials,
...
const MarineEcosystemProtectionData = ({
  setManualData,
  setUploadManually,
}) => {
  ...
  const [areaOfEcosystemProtected, setAreaOfEcosystemProtected] =
    useState<string>("");
  ...
  const handleSubmit = async () => {
    ...
    if (programs.length === 0) {
      toast.error(
        "Please add at least one marine ecosystem protection program you did",
        {
          position: "top-center",
          autoClose: 5000,
          hideProgressBar: false,
  ...
  return (
    <div>
      <div className="">
        <h3 className={styles.title}>Marine Ecosystem Protection</h3>
        ...
        <div className={styles.munualDataForm}>
          ...
          <div className={styles.inputDiv}>
            <label htmlFor={styles.inputLabel}>
              What is the name of the Marine Ecosystem Protection program?
            </label>
            <input
          ...
          <div className={styles.inputDiv}>
            <label htmlFor={styles.inputLabel}>
              What type of ecosystem is protected?
            </label>
            <select
              className={styles.formSelectInput}
              id="typeOfEcosystem"
            ...
            >
              <option value="">
                Select the type of marine ecosystem protected from the dropdown.
              </option>
          ...
          <div className={styles.inputDiv}>
            <label htmlFor={styles.inputLabel}>
              What size is the area protected?
            </label>
            <input
              className={styles.formInput}
