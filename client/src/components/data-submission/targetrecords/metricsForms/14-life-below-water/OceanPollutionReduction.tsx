...
import {
  OceanPollutionReductionData as OceanPollutionReductionDataType,
  Testimonials,
...
const OceanPollutionReductionData = ({ setManualData, setUploadManually }) => {
  ...
  const [typeOfPollutantsTargeted, setTypeOfPollutantsTargeted] =
    useState<string>("");
  ...
  const handleSubmit = async () => {
    ...
    if (programs.length === 0) {
      toast.error(
        "Please add at least one ocean pollution reduction program you did",
        {
          position: "top-center",
          autoClose: 5000,
          hideProgressBar: false,
  ...
  const handleSave = async () => {
    ...
    const newProgram: OceanPollutionReductionDataType = {
      ...
      duration,
      location,
      reductionInPollution: Number(reductionInPollution),
      typeOfPollutantsTargeted,
      description,
      objectives,
      notableAchievements,
  ...
  return (
    <div>
      <div className="">
        <h3 className={styles.title}> Ocean Pollution Reduction</h3>
        ...
        <div className={styles.munualDataForm}>
          ...
          <div className={styles.inputDiv}>
            <label htmlFor={styles.inputLabel}>
              What is the name of the Ocean Pollution Reduction program?
            </label>
            <input
          ...
          <div className={styles.inputDiv}>
            <label htmlFor={styles.inputLabel}>
              What type of pollutants are targeted?
            </label>
            <select
            ...
            >
              <option value="">
                Select the type of pollution targeted by the reduction efforts
                from the dropdown.
              </option>
          ...
          <div className={styles.inputDiv}>
            <label htmlFor={styles.inputLabel}>
              What is the volume of pollution reduction?
            </label>
            <input
              className={styles.formInput}
