...
import {SustainableFishingSupportData as SustainableFishingSupportDataType, Testimonials } from "../../../../../hooks/declarations/data/data.did";
...
const SustainableFishingSupportData = ({ setManualData, setUploadManually }) => {
  ...
  const [programs, setPrograms] = useState<SustainableFishingSupportDataType[]>([]);
  ...
  const handleSubmit = async () => {
    ...
    if (programs.length === 0) {
      toast.error("Please add at least one sustainable fishing support program you did", {
        position: "top-center",
        autoClose: 5000,
        hideProgressBar: false,
        closeOnClick: true,
    ...
    try {
      ...
      console.log("Error saving sustainable fishing support program", error);
    }
  };
  ...
  if (emptyFields.length > 0) {
    ...
    const newProgram: SustainableFishingSupportDataType = {
      programName,
  ...
  return (
    <div>
       <div className="">
        <h3 className={styles.title}>Sustainable Fishing Support</h3>
        ...
        <div className={styles.munualDataForm}>
          <div className={styles.formHeader}>
            <h3 className={styles.formTitle}>
              Add a Sustainable Fishing Support Program
            </h3>
          </div>
          <div className={styles.inputDiv}>
            <label htmlFor={styles.inputLabel}>What is the name of the Sustainable Fishing Support program?</label>
            <input
              className={styles.formInput}
              id="programName"
              type="text"
              placeholder="Enter the name of the sustainable fishing support program.
              "
              value={programName}
          ...
          <div className={styles.inputDiv}>
            ...
            <input
              ...
              id="startDate"
              type="date"
              placeholder="Indicate when the sustainable fishing efforts began."
              value={startDate}
              required
          ...
          <div className={styles.inputDiv}>
            <label htmlFor={styles.inputLabel}>What type of fishing method is used?</label>
            <select
              ...
              required
            >
              <option value="">Select the fishing method promoted by the program from the dropdown.</option>
              <option value="line-fishing">Line Fishing</option>
              <option value="net-fishing">Net-fishing</option>
...
export default SustainableFishingSupportData;
