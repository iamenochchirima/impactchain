...
import {
  EndangeredSpeciesProtectionData as EndangeredSpeciesProtectionDataType,
  Testimonials,
...
const EndangeredSpeciesProtectionData = ({
  setManualData,
  setUploadManually,
}) => {
  ...
  const [numberOfSpeciesProtected, setNumberOfSpeciesProtected] =
    useState<string>("");
  ...
  const [programs, setPrograms] = useState<
    EndangeredSpeciesProtectionDataType[]
  >([]);
  ...
  const handleSubmit = async () => {
    ...
    if (programs.length === 0) {
      toast.error(
        "Please add at least one endangered species protection program you did",
        {
          position: "top-center",
          autoClose: 5000,
          hideProgressBar: false,
  ...
  return (
    <div>
      <div className="">
        <h3 className={styles.title}>Endangered Species Protection</h3>
        ...
        <div className={styles.munualDataForm}>
          ...
          <div className={styles.inputDiv}>
            <label htmlFor={styles.inputLabel}>
              What is the name of the Endangered Species Protection program?
            </label>
            <input
          ...
          <div className={styles.inputDiv}>
            <label htmlFor={styles.inputLabel}>
              What type of species is protected?
            </label>
            <select
            ...
            >
              <option value="">
                Select the type of species being protected from the dropdown.
              </option>
