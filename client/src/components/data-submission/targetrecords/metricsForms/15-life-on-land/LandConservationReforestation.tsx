...
import {
  LandConservationReforestationData as LandConservationReforestationDataType,
  Testimonials,
...
const LandConservationReforestationData = ({
  setManualData,
  setUploadManually,
}) => {
  ...
  const [typeOfLandConservation, setTypeOfLandConservation] =
    useState<string>("");
  ...
  const [programs, setPrograms] = useState<
    LandConservationReforestationDataType[]
  >([]);
  ...
  const handleSubmit = async () => {
    ...
    if (programs.length === 0) {
      toast.error(
        "Please add at least one land conservation reforestation program you did",
        {
          position: "top-center",
          autoClose: 5000,
          hideProgressBar: false,
    ...
    try {
      ...
      console.log(
        "Error saving land conservation reforestation program",
        error
      );
    }
  };
  ...
  return (
    <div>
      <div className="">
        <h3 className={styles.title}>Land Conservation Reforestation</h3>
        ...
        <div className={styles.munualDataForm}>
          ...
          <div className={styles.inputDiv}>
            <label htmlFor={styles.inputLabel}>
              What is the name of the Land Conservation Reforestation program?
            </label>
            <input
          ...
          <div className={styles.inputDiv}>
            <label htmlFor={styles.inputLabel}>
              What type of land conservation is involved?
            </label>
            <select
            ...
            >
              <option value="">
                Select the type of land involved in the conservation efforts
                from the dropdown.
              </option>
          ...
          <div className={styles.inputDiv}>
            <label htmlFor={styles.inputLabel}>
              What is the area of the Land Conserved?
            </label>
            <input
              className={styles.formInput}
