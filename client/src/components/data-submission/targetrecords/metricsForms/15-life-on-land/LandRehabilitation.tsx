...
import {
  LandRehabilitationData as LandRehabilitationDataType,
  Testimonials,
...
const LandRehabilitationData = ({ setManualData, setUploadManually }) => {
  ...
  const [areaOfLandRehabilitated, setAreaOfLandRehabilitated] =
    useState<string>("");
  ...
  const handleSubmit = async () => {
    ...
    if (programs.length === 0) {
      toast.error(
        "Please add at least one land rehabilitation program you did",
        {
          position: "top-center",
          autoClose: 5000,
          hideProgressBar: false,
  ...
  return (
    <div>
      <div className="">
        <h3 className={styles.title}>Land Rehabilitation</h3>
        ...
        <div className={styles.munualDataForm}>
          ...
          <div className={styles.inputDiv}>
            <label htmlFor={styles.inputLabel}>
              What is the name of the Land Rehabilitation program?
            </label>
            <input
          ...
          <div className={styles.inputDiv}>
            <label htmlFor={styles.inputLabel}>
              What is the size of the area rehabilitated?
            </label>
            <input
              className={styles.formInput}
