...
import {
  AntiCorruptionProgramsData as AntiCorruptionProgramsDataType,
  Testimonials,
...
const AntiCorruptionProgramsData = ({ setManualData, setUploadManually }) => {
  ...
  const [natureOfAntiCorruptionMeasures, setNatureAntiCorruptionMeasures] =
    useState<string>("");
  ...
  return (
    <div>
      <div className="">
        <h3 className={styles.title}>Anti Corruption Programs</h3>
      ...
      {showForm && (
        <div className={styles.munualDataForm}>
          <div className={styles.formHeader}>
            <h3 className={styles.formTitle}>Add a Anti Corruption Program</h3>
          </div>
          <div className={styles.inputDiv}>
            <label htmlFor={styles.inputLabel}>
              What is the name of the Anti Corruption program?
            </label>
            <input
          ...
          <div className={styles.inputDiv}>
            <label htmlFor={styles.inputLabel}>
              What type of program is measured?
            </label>
            <select
            ...
            >
              <option value="">
                Select the type of anti-corruption measures implemented from the
                dropdown.
              </option>
