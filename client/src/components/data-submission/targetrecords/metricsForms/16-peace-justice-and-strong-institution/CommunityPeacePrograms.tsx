...
import { CommunityPeaceProgramsData as CommunityPeaceProgramsDataType, Testimonials } from "../../../../../hooks/declarations/data/data.did";
...
const CommunityPeaceProgramsData = ({ setManualData, setUploadManually }) => {
  ...
  return (
    <div>
      <div className="">
        <h3 className={styles.title}>Community Peace</h3>
      ...
      {showForm && (
        <div className={styles.munualDataForm}>
          <div className={styles.formHeader}>
            <h3 className={styles.formTitle}>Add a Community Peace Program</h3>
          </div>
          <div className={styles.inputDiv}>
            <label htmlFor={styles.inputLabel}>
              What is the name of the Community Peace program?
            </label>
            <input
          ...
          <div className={styles.inputDiv}>
            <label htmlFor={styles.inputLabel}>
              What type of peace initiative is implemented?
            </label>
            <select
              className={styles.formSelectInput}
              id="typeOfProgram"
            ...
            >
              <option value="">
                Select the type of peace initiative from the dropdown.
              </option>
          ...
          <div className={styles.inputDiv}>
            <label htmlFor={styles.inputLabel}>
              How many programs are conducted?
            </label>
            <input
              className={styles.formInput}
              id="numberOfPrograms"
