...
import {HumanRightsInitiativesData as HumanRightsInitiativeDataType } from "../../../../../hooks/declarations/data/data.did";
import { ManualData } from "../../MetricRecords";
import { IoMdAdd } from "react-icons/io";
import Program from "../support/Program";

const HumanRightsInitiativesData = ({ setManualData, setUploadManually }) => {
  ...
  const [programs, setPrograms] = useState<HumanRightsInitiativeDataType[]>([]);
  ...
  const handleSubmit = async () => {
    ...
    if (programs.length === 0) {
      toast.error("Please add at least one human rights initiative program you did", {
        position: "top-center",
        autoClose: 5000,
        hideProgressBar: false,
        closeOnClick: true,
    ...
    try {
      ...
      console.log("Error saving human rights initiative program", error);
    }
  };
    ...
    <div>
      <div className=" items-center">
        <h3 className="text-white mt-3 text-xl text-center font-NeueMachinaUltrabold">
          Human Rights and Justice Initiative
        </h3>
        ...
        <div className={styles.munualDataForm}>
          <div className={styles.formHeader}>
            <h3 className={styles.formTitle}>
              Add a Human Rights and Justice Initiative Program
            </h3>
          </div>
          <div className={styles.inputDiv}>
            <label htmlFor={styles.inputLabel}>What is the name of the Human Rights Initiative program?</label>
            <input
              className={styles.formInput}
              id="programName"
              type="text"
              placeholder="Enter the name of the human rights and justice initiative."
              value={programName}
          ...
          <div className={styles.inputDiv}>
            <label htmlFor={styles.inputLabel}>What type of initiative is supported?</label>
            <select
              ...
              required
            >
              <option value="">Select the type of initiative from the dropdown.</option>
          ...
          <div className={styles.inputDiv}>
            <label htmlFor={styles.inputLabel}>How many human rights and justice initiatives are accounted for?</label>
            <input
              className={styles.formInput}
              id="numberOfInitiatives"
              type="number"
              placeholder="Enter the number of human rights and justice initiatives conducted under this program."
...
export default HumanRightsInitiativesData;
