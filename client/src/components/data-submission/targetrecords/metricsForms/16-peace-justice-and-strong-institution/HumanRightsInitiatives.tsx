...
import {HumanRightsInitiativesData as HumanRightsInitiativeDataType, Testimonials } from "../../../../../hooks/declarations/data/data.did";
...
const HumanRightsInitiativesData = ({ setManualData, setUploadManually }) => {
 ...
 const [description, setDescription] = useState<string>("");
  ...
  return (
    <div>
        <div className="">
        <h3 className={styles.title}>Human Rights and Justice Initiative</h3>
