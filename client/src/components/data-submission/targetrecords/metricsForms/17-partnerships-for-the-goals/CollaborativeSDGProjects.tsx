...
import { CollaborativeSDGProjectsData as CollaborativeSDGProjectsDataType, Testimonials } from "../../../../../hooks/declarations/data/data.did";
...
const CollaborativeSDGProjectsData = ({ setManualData, setUploadManually }) => {
  ...
  return (
    <div>
      <div className="">
        <h3 className={styles.title}> Collaborative SDG Projects</h3>
        ...
        <div className={styles.munualDataForm}>
          ...
          <div className={styles.inputDiv}>
            <label htmlFor={styles.inputLabel}>
              What is the name of the Collaborative SDG Project?
            </label>
            <input
          ...
          <div className={styles.inputDiv}>
            ...
            >
              <option value="">
                Select the main focus of the collaborative project from the
                dropdown.
              </option>
