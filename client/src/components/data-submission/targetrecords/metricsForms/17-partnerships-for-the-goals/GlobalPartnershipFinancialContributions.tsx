...
import {
  GlobalPartnershipFinancialContributionsData as GlobalPartnershipFinancialContributionsDataType,
  Testimonials,
...
const GlobalPartnershipFinancialContributionsData = ({
  setManualData,
  setUploadManually,
}) => {
  ...
  const [programs, setPrograms] = useState<
    GlobalPartnershipFinancialContributionsDataType[]
  >([]);
  ...
  const handleSubmit = async () => {
    ...
    if (programs.length === 0) {
      toast.error(
        "Please add at least one global partnership financial contributions program you did",
        {
          position: "top-center",
          autoClose: 5000,
          hideProgressBar: false,
    ...
    try {
      ...
      console.log(
        "Error saving global partnership financial contributions program",
        error
      );
    }
  };
        ...
        <div className={styles.munualDataForm}>
          ...
          <div className={styles.inputDiv}>
            <label htmlFor={styles.inputLabel}>
              What is the name of the Global Partnership Financial Contributions
              program?
            </label>
            <input
          ...
          <div className={styles.inputDiv}>
            <label htmlFor={styles.inputLabel}>
              What type of contributions were given?
            </label>
            <select
            ...
            >
              <option value="">
                Select the type of financial contribution from the dropdown.
              </option>
              <option value="direct-funding">Direct Funding</option>
              <option value="in-kind-contributions">
          ...
          <div className={styles.inputDiv}>
            <label htmlFor={styles.inputLabel}>
              What is the amount that was contributed?
            </label>
            <input
              className={styles.formInput}
