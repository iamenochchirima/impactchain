...
import { SDGAdvocacyCampaignsData as SDGAdvocacyCampaignDataType, Testimonials } from "../../../../../hooks/declarations/data/data.did";
...
const SDGAdvocacyCampaignsData = ({ setManualData, setUploadManually }) => {
  ...
  const [typeOfCampaign, setTypeOfCampaign] = useState<string>("");
  const [numberOfCampaigns, setNumberOfCampaigns] = useState<string>("");
  const [scopeOfCampaign, setScopeOfCampaign] = useState<string>("");
  ...
  const [programs, setPrograms] = useState<SDGAdvocacyCampaignDataType[]>([]);
  ...
  const handleSubmit = async () => {
    ...
    if (programs.length === 0) {
      toast.error("Please add at least one SDG advocacy campaign program you did", {
        position: "top-center",
        autoClose: 5000,
        hideProgressBar: false,
        closeOnClick: true,
    ...
    try {
      ...
      console.log("Error saving SDG advocacy campaign program", error);
    }
  };
  ...
  return (
    <div>
       <div className="">
        <h3 className={styles.title}>SDG Advocacy Campaigns</h3>
        ...
        <div className={styles.munualDataForm}>
          <div className={styles.formHeader}>
            <h3 className={styles.formTitle}>
              Add a SDG Advocacy Campaigns Program
            </h3>
          </div>
          <div className={styles.inputDiv}>
            <label htmlFor={styles.inputLabel}>What is the name of the SDG Advocacy Campaigns program?</label>
            <input
              className={styles.formInput}
              id="programName"
              type="text"
              placeholder="Enter the name of the SDG advocacy campaign."
              value={programName}
          ...
          <div className={styles.inputDiv}>
            ...
            <input
              ...
              id="startDate"
              type="date"
              placeholder="Indicate when the campaign began."
              value={startDate}
              required
          ...
          <div className={styles.inputDiv}>
            ...
            <input
              ...
              id="location"
              type="text"
              placeholder="Specify the city and country where the campaign is conducted."
              value={location}
          ...
          <div className={styles.inputDiv}>
            <label htmlFor={styles.inputLabel}>What type of advocacy campaign is used?</label>
            <select
              ...
              required
            >
              <option value="">Select the type of advocacy campaign from the dropdown.</option>
              <option value="public-awareness">Public Awareness</option>
              <option value="policy-lobbying">Policy Lobbying</option>
              <option value="community-mobilization">Community Mobilization</option>
            </select>
          </div>
          <div className={styles.inputDiv}>
            <label htmlFor={styles.inputLabel}>How many campaigns are involved?</label>
            <input
              className={styles.formInput}
              id="numberOfCampaigns"
              type="number"
              placeholder="Enter the number of advocacy campaigns conducted under this initiative."
              value={numberOfCampaigns}
              onChange={(e) => setNumberOfCampaigns(e.target.value)}
              required
            />
          </div>
          <div className={styles.inputDiv}>
            <label htmlFor={styles.inputLabel}>What is the scope of the campaign?</label>
            <select
              className={styles.formSelectInput}
              id="scopeOfCampaign"
              value={scopeOfCampaign}
              onChange={(e) => setScopeOfCampaign(e.target.value)}
              required
            >
              <option value="">Specify the scope of the advocacy efforts (e.g., local, national, or international).</option>
...
export default SDGAdvocacyCampaignsData;