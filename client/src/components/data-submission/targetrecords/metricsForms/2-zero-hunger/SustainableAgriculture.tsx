...
import {
  SustainableAgricultureInvestment as SustainableAgricultureType,
  Testimonials,
...
const SustainableAgriculture = ({ setManualData, setUploadManually }) => {
  ...
  return (
    <div>
      <div className="">
        <h3 className={styles.title}> Sustainable Agriculture Investments</h3>
      ...
      {showForm && (
        <div className={styles.munualDataForm}>
          ...
          <div className={styles.inputDiv}>
            ...
            >
              <option value="">
                Select the primary type of investment from the dropdown.
              </option>
