...
import {
  SchoolsSupportedData as SchoolsSupportedDataType,
  Testimonials,
...
const SchoolsBuiltSupportedData = ({ setManualData, setUploadManually }) => {
  ...
  return (
    <div>
      <div className="">
        <h3 className={styles.title}> Schools Built or Supported </h3>
      ...
      {showForm && (
        <div className={styles.munualDataForm}>
          <div className={styles.formHeader}>
            <h3 className={styles.formTitle}>Add a School Support Program</h3>
          </div>
          <div className={styles.inputDiv}>
            <label htmlFor={styles.inputLabel}>
              What is the name of the School Support program?
            </label>
            <input
          ...
          <div className={styles.inputDiv}>
            ...
            >
              <option value="">
                Select the primary focus of the support provided to schools from
                the dropdown.
              </option>
          ...
          <div className={styles.inputDiv}>
            <label htmlFor={styles.inputLabel}>
              How many schools are built or supported?
            </label>
            <input
              className={styles.formInput}
