...
import {
  GenderEqualityWorkshopsData as GenderEqualityWorkshopsDataType,
  Testimonials,
...
const GenderEqualityWorkshopsData = ({ setManualData, setUploadManually }) => {
  ...
  const handleSubmit = async () => {
    ...
    if (programs.length === 0) {
      toast.error(
        "Please add at least one Gender Equality Workshop program you did",
        {
          position: "top-center",
          autoClose: 5000,
          hideProgressBar: false,
  ...
  return (
    <div>
      <div className="">
        <h3 className={styles.title}>Gender Equality Workshop</h3>
        ...
        <div className={styles.munualDataForm}>
          ...
          <div className={styles.inputDiv}>
            <label htmlFor={styles.inputLabel}>
              What is the name of the Gender Equality Workshop program?
            </label>
            <input
          ...
          <div className={styles.inputDiv}>
            <label htmlFor={styles.inputLabel}>
              What type of workshop is provided?
            </label>
            <select
            ...
            >
              <option value="">
                Select the main type of workshop conducted from the dropdown.
              </option>
