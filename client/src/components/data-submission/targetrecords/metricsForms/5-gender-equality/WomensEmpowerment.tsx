...
import {
  Testimonials,
  WomensEmpowermentProgramData as WomensEmpowermentProgramDataType,
...
const WomensEmpowermentProgramData = ({ setManualData, setUploadManually }) => {
  ...
  const handleSubmit = async () => {
    ...
    if (programs.length === 0) {
      toast.error(
        "Please add at least one womens empowerment program you did",
        {
          position: "top-center",
          autoClose: 5000,
          hideProgressBar: false,
  ...
  return (
    <div>
      <div className="">
        <h3 className={styles.title}> Women Empowerment</h3>
        ...
        <div className={styles.munualDataForm}>
          ...
          <div className={styles.inputDiv}>
            <label htmlFor={styles.inputLabel}>
              What is the name of the Women Empowerment program?
            </label>
            <input
