...
import { Testimonials, WorkplaceGenderEqualityPoliciesData as WorkplaceGenderEqualityPoliciesDataType } from "../../../../../hooks/declarations/data/data.did";
...
const WorkplaceGenderEqualityPoliciesData = ({ setManualData, setUploadManually }) => {
  ...
  const [numberOfPolicies, setNumberOfPolicies] = useState<string>("");
 ...
 const [description, setDescription] = useState<string>("");
  ...
  const handleSave = async () => {
    ...
    const newProgram: WorkplaceGenderEqualityPoliciesDataType = {
      ...
      objectives,
      notableAchievements,
      numberOfPolicies: BigInt(numberOfPolicies),
      challenges,
      plannedInitiatives,
      futureObjectives,
...
<div className="">
        <h3 className={styles.title}>Workplace Gender Equality Policies</h3>
      ...
      {showForm && (
        <div className={styles.munualDataForm}>
          ...
          <div className={styles.inputDiv}>
            <label htmlFor={styles.inputLabel}>How many policies are implemented?</label>
            <input
              className={styles.formInput}
              id="numberOfPolicies"
              type="number"
              placeholder="Enter the number of policies implemented."
              value={numberOfPolicies}
              onChange={(e) => setNumberOfPolicies(e.target.value)}
            />
          </div>
