...
import {
  Testimonials,
  WaterSanitationAccessData as WaterSanitationAccessDataType,
...
const WaterSanitationAccessData = ({ setManualData, setUploadManually }) => {
  ...
  const handleSubmit = async () => {
    ...
    if (programs.length === 0) {
      toast.error(
        "Please add at least one water and sanitation access program you did",
        {
          position: "top-center",
          autoClose: 5000,
          hideProgressBar: false,
        ...
        <div className={styles.munualDataForm}>
          ...
          <div className={styles.inputDiv}>
            <label htmlFor={styles.inputLabel}>
              What is the name of the Water and Sanitation Access program?
            </label>
            <input
          ...
          <div className={styles.inputDiv}>
            <label htmlFor={styles.inputLabel}>
              What is the total amount of funds allocated? (In ZAR)
            </label>
            <input
              className={styles.formInput}
