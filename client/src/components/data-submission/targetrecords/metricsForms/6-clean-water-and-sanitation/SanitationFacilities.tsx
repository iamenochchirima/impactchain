...
import {
  SanitationFacilitiesData as SanitationFacilitiesDataType,
  Testimonials,
...
const SanitationFacilitiesData = ({ setManualData, setUploadManually }) => {
  ...
  const handleSubmit = async () => {
    ...
    if (programs.length === 0) {
      toast.error(
        "Please add at least one sanitation facility program you did",
        {
          position: "top-center",
          autoClose: 5000,
          hideProgressBar: false,
  ...
  return (
    <div>
      <div className="">
        <h3 className={styles.title}>Sanitation Facilities</h3>
        ...
        <div className={styles.munualDataForm}>
          ...
          <div className={styles.inputDiv}>
            <label htmlFor={styles.inputLabel}>
              What is the name of the Sanitation Facility program?
            </label>
            <input
          ...
          <div className={styles.inputDiv}>
            ...
            >
              <option value="">
                Select the primary type of sanitation facility developed from
                the dropdown.
              </option>
