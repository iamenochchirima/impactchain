...
import {
  Testimonials,
  WaterConservationInitiativesData as WaterConservationInitiativesDataType,
...
const WaterConservationInitiativesData = ({
  setManualData,
  setUploadManually,
}) => {
  ...
  const [waterSaved, setWaterSaved] = useState<string>("");
  ...
  const [programs, setPrograms] = useState<
    WaterConservationInitiativesDataType[]
  >([]);
  ...
  const handleSubmit = async () => {
    ...
    if (programs.length === 0) {
      toast.error(
        "Please add at least one water conservation initiative program you did",
        {
          position: "top-center",
          autoClose: 5000,
          hideProgressBar: false,
  ...
  return (
    <div>
      <div className="">
        <h3 className={styles.title}>Water Conservation Initiatives</h3>
        ...
        <div className={styles.munualDataForm}>
          ...
          <div className={styles.inputDiv}>
            <label htmlFor={styles.inputLabel}>
              What is the name of the Water Conservation Initiatives program?
            </label>
            <input
          ...
          <div className={styles.inputDiv}>
            <label htmlFor={styles.inputLabel}>
              What type of Conservation Initiative is used?
            </label>
            <select
              className={styles.formSelectInput}
              id="typeOfInitiative"
            ...
            >
              <option value="">
                Select the main type of conservation initiative from the
                dropdown.
              </option>
              <option value="rainwater-harvesting">Rainwater Harvesting</option>
              <option value="water-recycling">Water Recycling</option>
              <option value="water-efficient-imigration">
                Water Efficient Imigration
              </option>
            </select>
          </div>
          <div className={styles.inputDiv}>
            <label htmlFor={styles.inputLabel}>
              How much water has been saved? (In Litres)
            </label>
            <input
              className={styles.formInput}
              id="waterSaved"
              type="number"
              placeholder="Enter the amount of water saved in litres."
              value={waterSaved}
          ...
          <div className={styles.inputDiv}>
            <label htmlFor={styles.inputLabel}>
              How many initiatives are included in this program?
            </label>
            <input
              className={styles.formInput}
          ...
          <div className={styles.inputDiv}>
            <label htmlFor={styles.inputLabel}>
              What is the total amount funded? (In ZAR)
            </label>
            <input
              className={styles.formInput}
              id="totalFunding"
