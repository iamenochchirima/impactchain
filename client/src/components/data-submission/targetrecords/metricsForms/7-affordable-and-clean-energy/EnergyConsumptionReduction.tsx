...
import {
  EnergyConsumptionReductionData as EnergyConsumptionReductionDataType,
  Testimonials,
...
const EnergyConsumptionReductionData = ({
  setManualData,
  setUploadManually,
}) => {
  ...
  const [measurementsUnitsUsed, setMeasurementsUnitsUsed] =
    useState<string>("");
  const [reductionInEnergyConsumption, setReductionInEnergyConsumption] =
    useState<string>("");
  ...
  const [programs, setPrograms] = useState<
    EnergyConsumptionReductionDataType[]
  >([]);
  ...
  const handleSubmit = async () => {
    ...
    if (programs.length === 0) {
      toast.error(
        "Please add at least one energy consumption reduction program you did",
        {
          position: "top-center",
          autoClose: 5000,
          hideProgressBar: false,
  ...
  return (
    <div>
      <div className="">
        <h3 className={styles.title}> Energy Consumption Reduction</h3>
        ...
        <div className={styles.munualDataForm}>
          ...
          <div className={styles.inputDiv}>
            <label htmlFor={styles.inputLabel}>
              What is the name of the Energy Consumption Reduction program?
            </label>
            <input
          ...
          <div className={styles.inputDiv}>
            ...
            >
              <option value="">
                Choose the unit of measurement used for reporting the energy
                reduction from the dropdown.
              </option>
          ...
          <div className={styles.inputDiv}>
            <label htmlFor={styles.inputLabel}>
              What is the volume of reduction in energy consumption?
            </label>
            <input
              className={styles.formInput}
