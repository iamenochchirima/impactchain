...
import { EnergyEfficientSystemsData as EnergyEfficientSystemsDataType, Testimonials } from "../../../../../hooks/declarations/data/data.did";
...
const EnergyEfficientSystemsData = ({ setManualData, setUploadManually }) => {
  ...
  const [numberOfSystemsInstalled, setNumberOfSystemsInstalled] =
    useState<string>("");
  ...
  const handleSubmit = async () => {
    ...
    if (programs.length === 0) {
      toast.error(
        "Please add at least one energy efficient systems program you did",
        {
          position: "top-center",
          autoClose: 5000,
          hideProgressBar: false,
  ...
  return (
    <div>
      <div className="">
        <h3 className={styles.title}>Energy Efficient Systems</h3>
        ...
        <div className={styles.munualDataForm}>
          ...
          <div className={styles.inputDiv}>
            <label htmlFor={styles.inputLabel}>
              What is the name of the Energy Efficient Systems program?
            </label>
            <input
          ...
          <div className={styles.inputDiv}>
            ...
            >
              <option value="">
                Select the type of energy-efficient system installed from the
                dropdown.
              </option>
              <option value="HVAC">HVAC</option>
              <option value="lighting">Lighting</option>
              <option value="insulation">Insulation</option>
              <option value="energy-management-systems">
