...
import {
  RenewableEnergyProjectsData as RenewableEnergyProjectsDataType,
  Testimonials,
...
const RenewableEnergyProjectsData = ({ setManualData, setUploadManually }) => {
  ...
  const [typeOfRenewableEnergy, setTypeOfRenewableEnergy] =
    useState<string>("");
  ...
  return (
    <div>
      <div className="">
        <h3 className={styles.title}>Renewable Energy Projects</h3>
      ...
      {showForm && (
        <div className={styles.munualDataForm}>
          <div className={styles.formHeader}>
            <h3 className={styles.formTitle}>Add a Renewable Energy Project</h3>
          </div>
          <div className={styles.inputDiv}>
            <label htmlFor={styles.inputLabel}>
              What is the name of the Renewable Energy project?
            </label>
            <input
          ...
          <div className={styles.inputDiv}>
            <label htmlFor={styles.inputLabel}>
              Where is this project located? (City and Country)
            </label>
            <input
              className={styles.formInput}
              id="location"
          ...
          <div className={styles.inputDiv}>
            <label htmlFor={styles.inputLabel}>
              What type of renewable energy used?
            </label>
            <select
            ...
            >
              <option value="">
                Select the primary type of renewable energy used in the project
                from the dropdown.
              </option>
          ...
          <div className={styles.inputDiv}>
            <label htmlFor={styles.inputLabel}>
              How many renewable energy projects are initated?
            </label>
            <input
              className={styles.formInput}
              id="numberOfProjects"
