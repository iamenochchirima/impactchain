...
import {
  EmploymentConditionsImprovementData as EmploymentConditionsImprovementDataType,
  Testimonials,
...
const EmploymentConditionsImprovementData = ({
  setManualData,
  setUploadManually,
}) => {
  ...
  const [programs, setPrograms] = useState<
    EmploymentConditionsImprovementDataType[]
  >([]);
  ...
  const handleSubmit = async () => {
    ...
    if (programs.length === 0) {
      toast.error(
        "Please add at least one employment conditions improvement program you did",
        {
          position: "top-center",
          autoClose: 5000,
          hideProgressBar: false,
    ...
    try {
      ...
      console.log(
        "Error saving employment conditions improvement program",
        error
      );
    }
  };
  ...
  return (
    <div>
      <div className="">
        <h3 className={styles.title}>Employment Conditions Improvement</h3>
        ...
        <div className={styles.munualDataForm}>
          ...
          <div className={styles.inputDiv}>
            <label htmlFor={styles.inputLabel}>
              What is the name of the Employment Conditions Improvement program?
            </label>
            <input
          ...
          <div className={styles.inputDiv}>
            <label htmlFor={styles.inputLabel}>
              What type of improvement considered?
            </label>
            <select
            ...
            >
              <option value="">
                Select the type of improvement from the dropdown.
              </option>
