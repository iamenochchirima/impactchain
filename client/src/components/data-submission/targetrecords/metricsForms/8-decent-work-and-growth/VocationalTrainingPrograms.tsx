...
import { VocationalTrainingProgramsData as VocationalTrainingProgramsDataType } from "../../../../../hooks/declarations/data/data.did";
import { ManualData } from "../../MetricRecords";
import { IoMdAdd } from "react-icons/io";
import Program from "../support/Program";

const VocationalTrainingProgramsData = ({ setManualData, setUploadManually }) => {
  ...
  const [programs, setPrograms] = useState<VocationalTrainingProgramsDataType[]>([]);
  ...
  const handleSubmit = async () => {
    ...
    if (programs.length === 0) {
      toast.error("Please add at least one vocational training program you did", {
        position: "top-center",
        autoClose: 5000,
        hideProgressBar: false,
        closeOnClick: true,
      ...
      {showForm && (
        <div className={styles.munualDataForm}>
          ...
          <div className={styles.inputDiv}>
            <label htmlFor={styles.inputLabel}>What is the name of the Vocational Training program?</label>
            <input
          ...
          <div className={styles.inputDiv}>
            <label htmlFor={styles.inputLabel}>What type of vocational training is provided?</label>
            <select
