...
import { PeopleBenefitingFromInfrastructureData as PeopleBenefitingFromInfrastructureDataType, Testimonials } from "../../../../../hooks/declarations/data/data.did";
...
const PeopleBenefitingFromInfrastructureData = ({
  setManualData,
  setUploadManually,
}) => {
  ...
  const [programs, setPrograms] = useState<
    PeopleBenefitingFromInfrastructureDataType[]
  >([]);
  ...
  const handleSubmit = async () => {
    ...
    if (programs.length === 0) {
      toast.error(
        "Please add at least one People Benefiting from Infrastructure program you did",
        {
          position: "top-center",
          autoClose: 5000,
          hideProgressBar: false,
    ...
    try {
      ...
      console.log(
        "Error saving People Benefiting from Infrastructure program",
        error
      );
    }
  };
  ...
  return (
    <div>
      <div className="">
        <h3 className={styles.title}>People Benefiting from Infrastructure</h3>
        ...
        <div className={styles.munualDataForm}>
          ...
          <div className={styles.inputDiv}>
            <label htmlFor={styles.inputLabel}>
              What is the name of the People Benefiting from Infrastructure
              program?
            </label>
            <input
          ...
          <div className={styles.inputDiv}>
            <label htmlFor={styles.inputLabel}>
              How many individuals benefit from this initiative?
            </label>
            <input
              className={styles.formInput}
