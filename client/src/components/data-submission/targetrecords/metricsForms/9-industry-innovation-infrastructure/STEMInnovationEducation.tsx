...
import { STEMInnovationEducationData as STEMInnovationEducationDataType } from "../../../../../hooks/declarations/data/data.did";
import { ManualData } from "../../MetricRecords";
import { IoMdAdd } from "react-icons/io";
import Program from "../support/Program";

const STEMInnovationEducationData = ({ setManualData, setUploadManually }) => {
  ...
  const [programs, setPrograms] = useState<STEMInnovationEducationDataType[]>([]);
  ...
  const handleSubmit = async () => {
    ...
    if (programs.length === 0) {
      toast.error("Please add at least one STEM and Innovation program you did", {
        position: "top-center",
        autoClose: 5000,
        hideProgressBar: false,
        closeOnClick: true,
    ...
    try {
      ...
      console.log("Error saving STEM and Innovation program", error);
    }
  };
  ...
  const handleSave = async () => {
    ...
    const newProgram: STEMInnovationEducationDataType = {
      programName,
        ...
        <div className={styles.munualDataForm}>
          <div className={styles.formHeader}>
            <h3 className={styles.formTitle}>
              Add a STEM and Innovation Education Program
            </h3>
          </div>
          <div className={styles.inputDiv}>
            <label htmlFor={styles.inputLabel}>What is the name of the STEM and Innovation Education program?</label>
            <input
              className={styles.formInput}
              id="programName"
              type="text"
              placeholder="Enter the specific name of the STEM and innovation education program."
              value={programName}
          ...
          <div className={styles.inputDiv}>
            <label htmlFor={styles.inputLabel}>What type of programss are provided?</label>
            <select
          ...
          <div className={styles.inputDiv}>
            <label htmlFor={styles.inputLabel}>How many participants are involved in this program?</label>
            <input
              className={styles.formInput}
              id="totalParticipants"
              type="number"
              placeholder="Enter the total number of STEM and innovation education participants under this initiative."
...
export default STEMInnovationEducationData;