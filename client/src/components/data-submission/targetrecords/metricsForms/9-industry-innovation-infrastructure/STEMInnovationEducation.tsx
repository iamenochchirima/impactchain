...
import { STEMInnovationEducationData as STEMInnovationEducationDataType, Testimonials } from "../../../../../hooks/declarations/data/data.did";
...
const STEMInnovationEducationData = ({ setManualData, setUploadManually }) => {
  ...
  const handleSubmit = async () => {
    ...
    if (programs.length === 0) {
      toast.error(
        "Please add at least one STEM and Innovation program you did",
        {
          position: "top-center",
          autoClose: 5000,
          hideProgressBar: false,
  ...
  return (
    <div>
      <div className="">
        <h3 className={styles.title}>STEM Innovation and Education</h3>
        ...
        <div className={styles.munualDataForm}>
          ...
          <div className={styles.inputDiv}>
            <label htmlFor={styles.inputLabel}>
              What is the name of the STEM and Innovation Education program?
            </label>
            <input
          ...
          <div className={styles.inputDiv}>
            <label htmlFor={styles.inputLabel}>
              What type of programss are provided?
            </label>
            <select
            ...
            >
              <option value="">
                Select the primary focus of the program from the dropdown.
              </option>
          ...
          <div className={styles.inputDiv}>
            <label htmlFor={styles.inputLabel}>
              How many participants are involved in this program?
            </label>
            <input
              className={styles.formInput}
