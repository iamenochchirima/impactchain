...
import { SustainableInfrastructureData as SustainableInfrastructureDataType, Testimonials } from "../../../../../hooks/declarations/data/data.did";
...
const SustainableInfrastructureData = ({
  setManualData,
  setUploadManually,
}) => {
  ...
  const handleSubmit = async () => {
    ...
    if (programs.length === 0) {
      toast.error(
        "Please add at least one sustainable infrastructure program you did",
        {
          position: "top-center",
          autoClose: 5000,
          hideProgressBar: false,
  ...
  return (
    <div>
      <div className="">
        <h3 className={styles.title}>Sustainable Infrastructure </h3>
        ...
        <div className={styles.munualDataForm}>
          ...
          <div className={styles.inputDiv}>
            <label htmlFor={styles.inputLabel}>
              What is the name of the Sustainable Infrastructure program?
            </label>
            <input
          ...
          <div className={styles.inputDiv}>
            <label htmlFor={styles.inputLabel}>
              What type of infrastructure is provided?
            </label>
            <select
              className={styles.formSelectInput}
            ...
            >
              <option value="">
                Select the type of infrastructure from the dropdown.
              </option>
