...
export const dataCanisterId = "bw4dl-smaaa-aaaaa-qaacq-cai";
export const storageCanId = "br5f7-7uaaa-aaaaa-qaaca-cai";
export const scalingCanId = "bd3sg-teaaa-aaaaa-qaaba-cai";