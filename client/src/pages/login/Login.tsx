...
const Login = () => {
  ...
  return (
    <div className="bg-black min-h-screen w-screen text-custom-green pt-44">
      <h1 className="font-NeueMachinaUltrabold text-[40px] md:text-7xl text-center">
        <span className="text-custom-green ">impact.</span>
        <span className="text-white">chain</span>{" "}
      </h1>
      <div className="flex flex-col justify-center items-center">
        <div className="flex flex-col items-center ">
          <h3 className=" font-TelegraphBold text-2xl md:text-3xl pt-3 text-custom-green">
            Login
          </h3>
            ...
            onSubmit={handleLogin}
             className="bg-black shadow-md font-TelegraphRegular rounded px-3 pt-3 pb-8 ">
              <div className="mb-4 min">
                <input
                  className="shadow placeholder-white min-w-[250px]  placeholder:font-semibold  rounded-3xl appearance-none border-2 border-green-500 w-full py-2 px-3 text-gray-white bg-black leading-tight focus:outline-none focus:shadow-outline"
                  id="email"
                  type="email"
                  placeholder="Email"
                 value = {email}
